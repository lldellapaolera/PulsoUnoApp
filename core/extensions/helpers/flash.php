...
class Flash
{
    ...
    public static function show(string $name, string $text): void
    {
        ...
        if ($name === 'error') {
            ...
            throw new InvalidArgumentException("Tipo de mensaje '$name' no es válido. Use:  error, warning, info o valid.");    
        }
        if (isset($_SERVER['SERVER_SOFTWARE'])) {
            echo '<div class="alert alert-', $alertType, ' flash">', $text, '</div>', PHP_EOL;
            return;
        }
        // salida CLI
